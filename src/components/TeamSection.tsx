...
import { MessageCircle, Phone, UserCheck, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          ...
          <p className="mt-2 text-sm sm:text-base text-slate-600">
            Skip automated bots. Connect directly with Naveen and Ajay for instant booking assistance and advice.
          </p>
        </div>
